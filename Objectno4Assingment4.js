//1. Create a constructor called Employee with atleast 3 properties and 2 behaviours and instantiate it 3 times

function employee(name , nativePlace , workingPlace , joinedDate, salary){
    this.name = name ;
